...
\experienceDetails{Project Oversight}{
    \item \small Directed the deployment of scalable applications leveraging open-source tools and GCP, reducing operational overhead by 25\%
    \item \small Secured funding of \$100,000 for developing an open-source, LLM-powered Data Quality Agent, enabling clients to achieve 50\% faster anomaly detection
