...
\experienceDetails{Project Oversight}{
    ...
    \item \small Secured funding of \$500,000 for developing an open-source, LLM-powered Data Quality Agent, enabling clients to achieve 50\% faster anomaly detection
    \item \small Spearheaded cross-functional delivery in Data Engineering, Data Quality, ML, and DevOps, ensuring all projects met 100\% on-time delivery milestones
}
    \vspace{5pt}
