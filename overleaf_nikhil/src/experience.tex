...
\experienceDetails{Client Relationship Management}{
    \item \small Grew account revenue by 30\% in 9 months by leveraging trust from early DE wins to pitch new ML and DQ projects
    \item \small Maintained 95\%+ CSAT by proactively resolving blockers, delivering executive-ready insights, and enabling faster go-lives
